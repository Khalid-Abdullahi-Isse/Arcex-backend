...
exports.SalesTrendQueryDto = exports.DateRangeQueryDto = void 0;
...
class SalesTrendQueryDto extends DateRangeQueryDto {
}
exports.SalesTrendQueryDto = SalesTrendQueryDto;
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(['day', 'week', 'month']),
    __metadata("design:type", String)
], SalesTrendQueryDto.prototype, "granularity", void 0);
